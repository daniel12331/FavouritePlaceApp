...
abstract class SwipeToDelete(context: ListFragment) : ItemTouchHelper.SimpleCallback(0, ItemTouchHelper.LEFT) {

    private val deleteIcon = ResourcesCompat.getDrawable(context.resources, R.drawable.ic_baseline_delete_24, null)
